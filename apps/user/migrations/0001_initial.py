    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent_user', models.ForeignKey(blank=True, help_text='Only populate for subuser', limit_choices_to={'account_type__in': ['user', 'administrator']}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='children', to=settings.AUTH_USER_MODEL, verbose_name='Parent User')),
